      ...
      <div style={{maxWidth:"1000px",margin:"0 auto",padding:"0 48px"}}>
        <RevealSection>
          <div style={{marginBottom:"60px",padding:"36px 40px",background:"rgba(255,255,255,.012)",border:"1px solid rgba(255,255,255,.04)"}}>
            ...
            <p style={{fontSize:"1rem",lineHeight:1.9,color:"rgba(232,240,248,.62)",fontStyle:"italic",marginBottom:"16px"}}>The starting dasha is determined by the Moon's nakshatra at birth and the exact degree within that nakshatra. The remaining balance of the nakshatra ruler's dasha is calculated proportionally. From that starting point, the nine planets cycle in the fixed Vimshottari sequence: Ketu, Venus, Sun, Moon, Mars, Rahu, Jupiter, Saturn, Mercury — then returning to Ketu for the next cycle.</p>
            <p style={{fontSize:".9rem",lineHeight:1.8,color:"rgba(232,240,248,.42)",fontStyle:"italic"}}>Each Mahadasha is subdivided into nine Antardashas (sub-periods) in the same sequence, beginning with the Mahadasha lord itself. Within Antardashas, further subdivision into Pratyantardashas is possible — creating extraordinary precision for timing specific events to within weeks.</p>
          </div>
        </RevealSection>
          ...
          {dashas.map((d,i)=>(
            <RevealSection key={d.planet} delay={i*60}>
              <div style={{position:"relative",display:"grid",gridTemplateColumns:"200px 1fr",gap:"48px",padding:"48px 0",borderBottom:"1px solid rgba(255,255,255,.03)"}}>
                ...
                <div>
                  <div style={{fontFamily:"'Cinzel',serif",fontSize:"1.1rem",color:"rgba(232,240,248,.85)",marginBottom:"14px",letterSpacing:".08em"}}>{d.essence}</div>
        ...
        <RevealSection>
          <div style={{marginTop:"80px",padding:"48px",border:"1px solid rgba(200,168,76,.1)",background:"rgba(200,168,76,.02)",textAlign:"center"}}>
            ...
            <p style={{fontSize:"1.05rem",fontStyle:"italic",lineHeight:2,color:"rgba(232,240,248,.62)",maxWidth:"680px",margin:"0 auto"}}>
